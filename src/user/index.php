...
$masyarakat = mysqli_query($conn, "SELECT * FROM masyarakat ORDER BY id_user  DESC LIMIT 1");
...
<nav class="navbar navbar-expand-lg navbar-dark bg-primary py-3 shadow">
  <div class="container" data-aos="fade-down">
    <a class="navbar-brand" href="#">
      <i class="fas fa-atlas"></i> <b>PengMas</b>
    </a>
...
<div class="bg-gradient-primary" style="border-bottom-right-radius: 100px; border-bottom-left-radius: 100px; padding:150px;">
  <div class="container d-flex justify-content-center" data-aos="zoom-in">
    <div class="text-center col-8 text-light" style="margin-top: -25px;">
      <h1><b>PengMas</b></h1>
      <p> PengMas (Pengaduan Masyarakat) adalah aplikasi inovatif yang memungkinkan masyarakat secara mudah dan efisien melaporkan berbagai permasalahan atau kejadian yang membutuhkan perhatian pemerintah atau lembaga terkait. Aplikasi ini bertujuan untuk meningkatkan partisipasi aktif warga dalam membangun masyarakat yang lebih baik melalui pelaporan yang cepat, akurat, dan terkelola dengan baik.</p>
      ...
      <div class="col-md-4 mb-4" data-aos="fade-up" data-aos-duration="900">
        <div class="card border-left-warning border-bottom-warning shadow-lg h-100 py-2">
          <div class="card-body">
            <div class="row no-gutters align-items-center">
              <div class="col ml-3">
                <div class="h5 mb-0 font-weight-bold text-warning"><?= $row['id_user']; ?> Akun masyarakat</div>
              </div>
...
<div class="bg-gray-400 py-3">
  <footer>
    <div class="text-center mt-2 text-gray-700">
      <h6>Copyright &copy;2024 -SatrioAndika-.</h6>
    </div>
  </footer>
</div>
