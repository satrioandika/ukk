				...
				<tr>
					<center>
						<td align="center" width="100%">
							<font style="font-size:22px; font-family:Arial, Helvetica, sans-serif; text-align:center;">PEMERINTAH KABUPATEN JOMBANG<br />KECAMATAN KESAMBEN<br />DESA JOMBATAN</font><br /><i>
								<font style="font-size:15px;">Jl. Sedap Malam No 11 Jombatan-Kesamben-Jombang 61484</font>
							</i>
						</td>
					</center>
				</tr>
	...
	<table align="center" border="1" cellpadding="12" cellspacing="0">
		...
		?>
				...
				<tr>
					...
					<td><img src="../../assets/img/<?= $data["foto"]; ?>" width="50"></td>
				</tr>
		<?php }
		} else {
